...
export default function Home() {
  ...
  return <main>
    <section className="hero-shell">
      ...
      <div className="hero-visual"><div className="orange-orbit"/><div className="floating-card pickup-card"><span className="float-icon"><Icon name="bag" size={16}/></span><div><small>COLLECTION CONFIRMED</small><strong>Tesco Ardkeen</strong></div><b>✓</b></div><div className="floating-card eta-card"><span className="pulse"/><div><small>DRIVER ON THE WAY</small><strong>Shane · 8 mins away</strong></div></div><div className="phone"><div className="phone-speaker"/><div className="phone-logo"><img src="/onit.svg" alt=""/></div><p className="phone-hi">Good morning, Liezel</p><h3>What do you need delivered?</h3><div className="phone-shortcuts"><span><Icon name="bag" size={15}/><small>Shop</small></span><span><Icon name="plus" size={15}/><small>Parcel</small></span><span><Icon name="pin" size={15}/><small>Other</small></span></div><div className="phone-job"><span className="float-icon green"><Icon name="truck" size={16}/></span><div><small>ACTIVE DELIVERY</small><strong>Arriving in 8 mins</strong></div><b>•••</b></div><button>Request delivery</button></div><div className="floating-card delivered-card"><span className="float-icon green"><Icon name="check" size={16}/></span><div><small>DELIVERED</small><strong>Order completed</strong></div></div></div></div>
    </section>
    ...
    <section className="driver-cta" id="drivers"><div><span className="eyebrow">DRIVE ON YOUR TERMS</span><h2>Local routes.<br/>Extra income.</h2><p>Create a driver account, see available requests and choose the jobs that work for you.</p><button className="primary" onClick={() => { setAuthMode("signup"); setAccountType("driver"); setAuthOpen(true); }}>Sign up as a driver <Icon name="arrow"/></button></div><div className="driver-route-art" aria-label="Illustration of an Onit delivery route"><div className="route-copy"><span>ONIT DRIVER NETWORK</span><strong>You drive.<br/>We keep you moving.</strong></div><svg className="route-line" viewBox="0 0 520 300" fill="none" aria-hidden="true"><path d="M75 238C143 236 132 91 236 106C323 119 330 215 445 166"/><path className="route-dashes" d="M75 238C143 236 132 91 236 106C323 119 330 215 445 166"/></svg><div className="route-place route-shop"><span><Icon name="bag" size={19}/></span><small>COLLECT</small><b>Local shop</b></div><div className="route-place route-home"><span><Icon name="pin" size={19}/></span><small>DELIVER</small><b>Customer</b></div><div className="driver-marker"><span><Icon name="truck" size={25}/></span><div><small>ONIT DRIVER</small><b>8 mins away</b></div></div><div className="route-status"><i/><span><small>DELIVERY AVAILABLE</small><b>Waterford · €8.50</b></span></div></div></section>
